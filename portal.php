...
<header class="masthead">
	<div class="container">
		...
		<div class="masthead-heading text-uppercase">Why Choose us?</div>
		<h5>want to explore Bali up and down? we’ll help!<br>
			with our service you can find beautiful scenics spot, popular locations<br>
			and also book your acomodations </h5>
...
<section class="page-section bg-dark" id="home">
	<div class="container">
		...
		<div class="d-flex w-100 justify-content-center">
			<hr style="border:3px solid; color:#4FC0D0;" width="15%">
		</div>
		<div class="row">
			<?php
					...
					<div class="card w-100 rounded-lg">
						...
						<div class="card-body">
							...
							<div class="w-100 d-flex justify-content-end">
								<a href="./?page=view_package&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning" id="tombol">View Package <i class="fa fa-arrow-right"></i></a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="d-flex w-100 justify-content-end">
			<a href="./?page=packages" class="btn btn-flat btn-warning mr-4" id="tombol">Explore Package <i class="fa fa-arrow-right"></i></a>
		</div>
	</div>
</section>
<!-- About-->
